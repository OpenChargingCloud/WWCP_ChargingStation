...
namespace org.GraphDefined.WWCP.EMSP
{
    ...
    public class ProviderAPI
    {
        ...
        #region OnDeleteReservation

        /// <summary>
        /// An event sent whenever a reservation will be cancelled by an EV customer.
        /// </summary>
        public event RequestLogHandler            OnReservationDeleteLog;

        /// <summary>
        /// An event sent whenever a reservation will be cancelled by an EV customer.
        /// </summary>
        public event OnDeleteReservationDelegate  OnDeleteReservation;

        /// <summary>
        /// An event sent whenever a reservation was cancelled by an EV customer.
        /// </summary>
        public event AccessLogHandler             OnReservationDeletedLog;
